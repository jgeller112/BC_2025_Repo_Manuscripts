...
-   If I take the same analysis pipeline and apply it the same dataset, I will get the same results

    -   This is reproduciblity
...
::: {.column width="50%"}
![](images/excel_error.jpg){fig-align="center" width="369"}
:::
:::::
